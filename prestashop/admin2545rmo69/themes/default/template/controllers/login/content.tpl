...
<div id="login-panel">
	...
	<div id="login-footer">
		<p class="text-center text-muted">
			<a href="http://www.shoffex.com/" onclick="return !window.open(this.href);">
				&copy; SHOFFEX {$smarty.now|date_format:"%Y"} - All rights reserved
			</a>
		</p>
		<p class="text-center">
			<a class="link-social link-twitter _blank" href="https://twitter.com/shoffexshop" title="Twitter">
				<i class="icon-twitter"></i>
			</a>
			<a class="link-social link-facebook _blank" href="https://www.facebook.com/shoffex" title="Facebook">
				<i class="icon-facebook"></i>
			</a>
			<a class="link-social link-google _blank" href="https://plus.google.com/u/0/104863477907758371781/posts" title="Google">
